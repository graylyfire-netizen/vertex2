...
module.exports = {
  name: "metadata",
  description: "Modify a item's metadata (DROP TO BOT)",
  ...
  options: [
    ...
    },
    {
      type: 3,
      name: "item_name",
      description: "Item to change metadata to",
      required: true,
      min_length: 1,
      max_length: 64
    },
    {
      type: 4,
      name: "value",
      description: "Value to set the metadata to",
      required: true,
      min_value: -32767,
      max_value: 32767
    }
  ...
  execute: async (interaction, args, dbUser, embed, clearCooldown) => {
    const { input, item_name, value } = args;
