...
const { translateDisconnectMessage, cleanLeftovers, delay, fillObjects } = require("../../common/Util.js");
...
module.exports = {
  name: "freeze",
  description: 'Freeze a realm over with snow',
